...
model_configurations = Dict(
    :ANN => [Dict("topology" => t, "numExecutions" => 50, "maxEpochs" => 100, "learningRate"=> 0.01, "validationRatio" =>0.2, "maxEpochsVal" => 20) for t in topologies],  # 8 configuraciones de redes neuronales
